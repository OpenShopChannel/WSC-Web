...
<#global TemplateUtil=statics['org.oscwii.shop.utils.TemplateUtil']>
...
<body onload="onLoad()">
    <div id="main-header">
        <div id="main-header-contents">
            <#if showTitle>
            <h1 class="heading<#if headerTitleBlue || !(headerTitle?has_content)> blue</#if>" id="main-heading"><#if headerTitle?has_content>${headerTitle}<#else>${TemplateUtil.openify("Open")} Shop Channel</#if></h1>
            </#if>
            <#nested>
            <#if headerBtns>
...
<#macro footer dots=true>
    <div id="main-footer">
        <#if dots><div class="dots">･･･${TemplateUtil.openify("････")}････････････････････････････････････････････････････････････････････</div></#if>
